...
pub fn derive_type_struct(ident: &Ident, data: &DataStruct) -> TokenStream2 {
    ...
    quote! {
        ...
        impl soroban_env_common::TryFromVal<crate::Host, soroban_env_common::Object> for #ident {
            fn try_from_val(env: &crate::Host, val: &soroban_env_common::Object) -> Result<Self, crate::HostError> {
        ...
        impl soroban_env_common::TryFromVal<crate::Host, soroban_env_common::RawVal> for #ident {
            fn try_from_val(env: &crate::Host, val: &soroban_env_common::RawVal) -> Result<Self, crate::HostError> {
        ...
        impl soroban_env_common::TryFromVal<crate::Host, #ident> for soroban_env_common::RawVal {
            fn try_from_val(env: &crate::Host, val: &#ident) -> Result<Self, crate::HostError> {
...
pub fn derive_type_enum(ident: &Ident, data: &DataEnum) -> TokenStream2 {
    ...
    if !errors.is_empty() {
        ...
        quote! {
            ...
            impl soroban_env_common::TryFromVal<crate::Host, #ident> for soroban_env_common::RawVal {
                fn try_from_val(env: &crate::Host, val: &#ident) -> Result<soroban_env_common::RawVal, crate::HostError> {
                    #(#consts;)*
