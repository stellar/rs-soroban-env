...
pub fn derive_type_struct(ident: &Ident, data: &DataStruct) -> TokenStream2 {
    ...
    quote! {
        ...
        impl soroban_env_common::ConvertFrom<soroban_env_common::Object, crate::Host> for #ident {
            type Error = crate::HostError;
        ...
        impl soroban_env_common::ConvertFrom<soroban_env_common::RawVal, crate::Host> for #ident {
            type Error = crate::HostError;

            fn try_from_val(env: &crate::Host, val: soroban_env_common::RawVal) -> Result<Self, Self::Error> {
                <_ as soroban_env_common::ConvertFrom<soroban_env_common::Object, crate::Host>>::try_from_val(env, val.try_into()?)
            }
        }

        impl soroban_env_common::ConvertFrom<#ident, crate::Host> for soroban_env_common::RawVal {
            type Error = crate::HostError;
