...
/// The VmCallerEnv trait is similar to the CheckedEnv trait -- it
...
///
/// There is a blanket `impl<T:VmCallerEnv> CheckedEnv for T` so that any
...
macro_rules! generate_vmcaller_checked_env_trait {
...

    {
        ...
        /// execution.
        ///
        /// There is also a blanket `impl<T:VmCallerEnv> CheckedEnv for
        /// T` that implements the `CheckedEnv` for any `VmCallerEnv` by
        ...
        /// everywhere.
        pub trait VmCallerEnv: crate::EnvBase
        {
            type VmUserState;
            $(
                $(
...
///////////////////////////////////////////////////////////////////////////////
/// X-macro use: impl<E> CheckedEnv for VmCallerEnv<E>
///////////////////////////////////////////////////////////////////////////////
...
macro_rules! impl_checked_env_for_vmcaller_checked_env {
...

    {
        ...
        // `VmCallerEnv` types automatically `CheckedEnv` types, just
