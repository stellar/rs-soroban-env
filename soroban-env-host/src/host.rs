...
impl VmCallerEnv for Host {
    ...
    fn bls12_381_check_g1_is_in_subgroup(
        ...
        let pt = self.g1_affine_deserialize_from_bytesobj(pt, true, false)?;
    ...
    fn bls12_381_g1_add(
        ...
        let p0 = self.g1_affine_deserialize_from_bytesobj(p0, true, false)?;
        let p1 = self.g1_affine_deserialize_from_bytesobj(p1, true, false)?;
    ...
    fn bls12_381_g1_mul(
        ...
        let p0 = self.g1_affine_deserialize_from_bytesobj(p0, true, true)?;
    ...
    fn bls12_381_check_g2_is_in_subgroup(
        ...
        let pt = self.g2_affine_deserialize_from_bytesobj(pt, true, false)?;
    ...
    fn bls12_381_g2_add(
        ...
        let p0 = self.g2_affine_deserialize_from_bytesobj(p0, true, false)?;
        let p1 = self.g2_affine_deserialize_from_bytesobj(p1, true, false)?;
    ...
    fn bls12_381_g2_mul(
        ...
        let p0 = self.g2_affine_deserialize_from_bytesobj(p0, true, true)?;
    ...
    fn bn254_g1_add(
        ...
        let p0 = self.bn254_g1_affine_deserialize(p0, true)?;
        let p1 = self.bn254_g1_affine_deserialize(p1, true)?;
    ...
    fn bls12_381_g1_is_on_curve(
        ...
        let pt = self.g1_affine_deserialize_from_bytesobj(point, false, false)?;
    ...
    fn bls12_381_g2_is_on_curve(
        ...
        let pt = self.g2_affine_deserialize_from_bytesobj(point, false, false)?;
    ...
    fn bn254_g1_is_on_curve(
        ...
        let pt = self.bn254_g1_affine_deserialize(point, false)?;
