...
pub type StorageMapType = MeteredOrdMap<Rc<LedgerKey>, Option<Rc<LedgerEntry>>, Budget>;
...
impl Storage {
    ...
    pub fn with_enforcing_footprint_and_map(footprint: Footprint, map: StorageMapType) -> Self {
        Self {
