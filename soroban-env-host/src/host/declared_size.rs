use crate::{
    ...
    xdr::{
        ...
        ScBytes, ScContractInstance, ScError, ScMap, ScMapEntry, ScNonceKey, ScString, ScSymbol,
        ScVal, ScVec, Signer, SorobanAuthorizationEntry, SorobanAuthorizedFunction,
...
impl_declared_size_type!(AccountAuthorizationTracker, 296);
...
mod test {
    ...
    fn test_expected_size() {
        ...
        expect!["304"].assert_eq(size_of::<SorobanAuthorizationEntry>().to_string().as_str());
        ...
        expect!["40"].assert_eq(size_of::<Memo>().to_string().as_str());
    ...
    fn test_declared_size() {
        ...
        assert_mem_size_le_declared_size!(Memo);
