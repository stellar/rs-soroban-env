...
fn test_wasm_upload_success_in_recording_mode() {
    ...
    let (expected_insns, expected_write_bytes) = (1767591, 684);
    assert_eq!(
        res.resources,
        SorobanResources {
...
fn test_auto_restore_with_extension_in_recording_mode() {
    ...
    assert_eq!(
        ...
        SorobanResources {
            ...
            instructions: 1025131,
            read_bytes: data_entry_size + wasm_entry_size + instance_entry_size,
...
fn test_auto_restore_with_overwrite_in_recording_mode() {
    ...
    assert_eq!(
        ...
        SorobanResources {
            ...
            instructions: 1026374,
            read_bytes: data_entry_size + instance_entry_size,
...
fn test_auto_restore_with_expired_temp_entry_in_recording_mode() {
    ...
    assert_eq!(
        ...
        SorobanResources {
            ...
            instructions: 1025097,
            read_bytes: wasm_entry_size + instance_entry_size,
...
fn test_auto_restore_with_recreated_temp_entry_in_recording_mode() {
    ...
    assert_eq!(
        ...
        SorobanResources {
            ...
            instructions: 1028030,
            read_bytes: wasm_entry_size,
