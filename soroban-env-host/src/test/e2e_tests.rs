...
fn test_wasm_upload_success_in_recording_mode() {
    ...
    let (expected_insns, expected_write_bytes) = match ledger_info.protocol_version {
        20 => (1060474, 636),
        21 => (1767136, 684),
        _ => (687178, 684),
    };
...
fn test_wasm_upload_failure_in_recording_mode() {
    ...
    assert!(res.auth.is_empty());
    let expected_instructions = match ledger_info.protocol_version {
        20 => 1093647,
        21 => 1093647,
        _ => 446951,
    };
...
fn test_invoke_contract_with_storage_ops_success_in_recording_mode() {
    ...
    let (expected_insns, expected_read_bytes) = match ledger_info.protocol_version {
        20 => (2221742, 3084),
        21 => (1431216, 3132),
        _ => (1164711, 3132),
    };
