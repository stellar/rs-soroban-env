...
fn test_create_contract_success_in_recording_mode() {
    ...
    expect!["284452"].assert_eq(&res.resources.instructions.to_string());
...
fn test_create_contract_success_in_recording_mode_with_custom_account() {
    ...
    assert_eq!(res.auth, vec![cd.auth_entry]);
    expect!["469290"].assert_eq(&res.resources.instructions.to_string());
...
fn test_create_contract_success_in_recording_mode_with_enforced_auth() {
    ...
    assert_eq!(res.auth, vec![cd.auth_entry]);
    expect!["285954"].assert_eq(&res.resources.instructions.to_string());
    expect!["104"].assert_eq(&res.resources.write_bytes.to_string());
    assert_eq!(
        res.resources,
        SorobanResources {
...
fn test_invoke_contract_with_storage_ops_success_in_recording_mode() {
    ...
    assert!(res.restored_rw_entry_ids.is_empty());
    expect!["389127"].assert_eq(&res.resources.instructions.to_string());
    ...
    expect!["380894"].assert_eq(&extend_res.resources.instructions.to_string());
    assert_eq!(
...
fn test_auto_restore_with_extension_in_recording_mode() {
    ...
    expect!["1040973"].assert_eq(&res.resources.instructions.to_string());
    assert_eq!(
        res.resources,
        SorobanResources {
            footprint: LedgerFootprint {
...
fn test_auto_restore_with_overwrite_in_recording_mode() {
    ...
    expect!["403746"].assert_eq(&res.resources.instructions.to_string());
    assert_eq!(
        res.resources,
        SorobanResources {
            footprint: LedgerFootprint {
...
fn test_auto_restore_with_new_entry_in_recording_mode() {
    ...
    let wasm_entry_size = cd.wasm_entry.to_xdr(Limits::none()).unwrap().len() as u32;
    expect!["1039246"].assert_eq(&res.resources.instructions.to_string());
    assert_eq!(
        res.resources,
        SorobanResources {
            footprint: LedgerFootprint {
...
fn test_auto_restore_with_expired_temp_entry_in_recording_mode() {
    ...
    expect!["1030489"].assert_eq(&res.resources.instructions.to_string());
    assert_eq!(
        res.resources,
        SorobanResources {
            footprint: LedgerFootprint {
...
fn test_auto_restore_with_recreated_temp_entry_in_recording_mode() {
    ...
    expect!["1033139"].assert_eq(&res.resources.instructions.to_string());
    assert_eq!(
        res.resources,
        SorobanResources {
            footprint: LedgerFootprint {
