...
fn excessive_logging() -> Result<(), HostError> {
    ...
    // moderate logging
    {
        ...
        expect![[r#"
            =================================================================
            Cpu limit: 2000000; used: 214209
            Mem limit: 500000; used: 166948
            =================================================================
            CostType                           cpu_insns      mem_bytes      
            WasmInsnExec                       300            0              
            MemAlloc                           16649          67528          
            MemCpy                             2343           0              
            MemCmp                             472            0              
        ...
        // expectations automatically at once if they're used multiple times).
        expected_budget = actual;
    }
