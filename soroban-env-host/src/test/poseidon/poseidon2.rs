...
mod poseidon2_tests_bls12 {
    ...
    fn kats() {
        ...
        let perm_2 = poseidon2_2.permutation(&input_2, &host).unwrap();
        ...
        let perm_3 = poseidon2_3.permutation(&input_3, &host).unwrap();
        ...
        let perm_4 = poseidon2_4.permutation(&input_4, &host).unwrap();
...
mod poseidon2_tests_bn256 {
    ...
    fn consistent_perm() {
        ...
        for _ in 0..TESTRUNS {
            ...
            let perm1 = poseidon2.permutation(&input1, &host).unwrap();
            let perm2 = poseidon2.permutation(&input1, &host).unwrap();
            let perm3 = poseidon2.permutation(&input2, &host).unwrap();
            assert_eq!(perm1, perm2);
            assert_ne!(perm1, perm3);
        }
    }
    ...
    fn kats() {
        ...
        let perm = poseidon2.permutation(&input, &host).unwrap();
