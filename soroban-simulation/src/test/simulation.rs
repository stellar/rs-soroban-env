...
use soroban_env_host::xdr::{
    ArchivalProof, ArchivalProofBody, ContractCostParamEntry, ContractCostParams, ContractCostType,
    ContractDataDurability, ContractDataEntry, ExtensionPoint, LedgerEntry, LedgerEntryData,
    LedgerFootprint, LedgerKey, LedgerKeyContractData, NonexistenceProofBody, ScAddress,
    ScErrorCode, ScErrorType, ScNonceKey, ScVal, SorobanAddressCredentials,
